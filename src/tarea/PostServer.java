...
public class PostServer extends Thread {
	...
	public PostServer(Socket client) {
	  ...
	  try {
        ...
        if (httpMethod.equals("GET")) {    
			...
			if (httpQueryString.equals("/")) {
   				  ...
   				  String responseString = PostServer.HTML_START + 
	...
	public void sendResponse (int statusCode, String responseString, boolean isFile) throws Exception {
		...
		if (isFile) {
			...
			responseString = PostServer.HTML_START + responseString + PostServer.HTML_END;
	...
	public static void main (String args[]) throws Exception {
		...
		while(true) {	                	   	      	
	            ...
	            (new PostServer(connected)).start();
        }      
	}
}
